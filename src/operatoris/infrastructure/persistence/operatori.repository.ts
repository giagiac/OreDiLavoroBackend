...
export abstract class OperatoriRepository {
  abstract create(data: Omit<Operatori, 'COD_OP' | 'createdAt' | 'updatedAt'>): Promise<Operatori>;
  ...
  abstract findById(COD_OP: Operatori['COD_OP']): Promise<NullableType<Operatori>>;

  abstract findByIds(ids: Operatori['COD_OP'][]): Promise<Operatori[]>;

  abstract update(COD_OP: Operatori['COD_OP'], payload: DeepPartial<Operatori>): Promise<Operatori | null>;
