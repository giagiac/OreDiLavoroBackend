...
export class X1TrasCodicisController {
  ...
  async findAll(
    @Query() query: FindAllX1TrasCodicisDto,
  ): Promise<InfinityPaginationResponseDto<X1TrasCodici>> {
  ...
  update(
    @Param('CODICE1') CODICE1: string,
    @Body() updateX1TrasCodiciDto: UpdateX1TrasCodiciDto,
  ) {
